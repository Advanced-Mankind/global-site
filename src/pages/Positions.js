    ...
    <Layout>
      ...
      >
          ...
          <div className="row">
            ...
            <div className="col-12 col-lg-8">
              <p className={`${styles.subTitle} mb-0`}>
                If you see a position that you are interested in please email us
                your resume and we will get back to you to start the interview
                process. We take onboarding very seriously so please only apply
                in your serious about the position.
              </p>
            </div>
            <div
              className="col-12"
        ...
        <div className="col col-sm-6 p-0 ">
          <div className={`${styles.leftContentPosition} d-none d-sm-block `}>
            <div style={{ marginTop: "20px" }}>
              <Link
                to="/Careers/"
                style={{
