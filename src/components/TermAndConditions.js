...
import "./PositionsPopup/stylesPopup.css";
    ...
    >
      <Modal.Header closeButton>
        <Modal.Title id="contained-modal-title-vcenter">
          <p className="title-form mb-0 ml-3">Terms & Conditions</p>
        </Modal.Title>
      </Modal.Header>
      <Modal.Body>
        {/* <Container
            ...
            >
              <div>
                <p>
                  ...
                  [Text Format] Last updated [month, day, year]
                </p>
                ...
                <p>
                  ...
                  to have accepted, the changes in any revised Terms and
                ...
                <p>
                  These terms and conditions were generated by Termly’s Terms
                ...
                <p>
                  ...
                  which they reside (generally under the age of 18) must have
                  the permission of, and be directly supervised by, their parent
                  or guardian to use the Site. If you are a minor, you must have
                  your parent or guardian read and agree to these Terms and
                  Conditions prior to you using the Site.
                </p>
