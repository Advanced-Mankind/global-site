...
const Step3 = ({
  ...
  return (
    <>
      <Container style={{ marginTop: "5%" }} className="step3Desktop">
        <Row>
          <Col className="imgStyle">
            <img
              src={require("../../../static/03Desktop.png")}
              alt="imgDesktop"
            />
          </Col>
          <Col>
            ...
            <Row className="justify-content-between">
              ...
              >
                <img
                  src={require("../../../static/circleGraphDesktop.png")}
                  alt="imgDesktop"
                />
              </Col>
      ...
      <Container style={{ marginTop: "5%" }} className="step3Tablet">
        <Row>
          <Col className="imgStyle" md="3">
            <img
              src={require("../../../static/03MobileTablet.png")}
              alt="imgDesktop"
            />
          </Col>
          <Col md="9">
            ...
            <Row className="justify-content-between">
              ...
              >
                <img
                  src={require("../../../static/circleGraphTablet.png")}
                  alt="imgDesktop"
                />
              </Col>
      ...
      <Container style={{ marginBottom: "60px" }} className="step3Mobile">
        <Row>
          <Col className="" sm="12">
            <img
              src={require("../../../static/03MobileTablet.png")}
          ...
          >
            ...
            >
              ...
              >
                <img
                  src={require("../../../static/circleGraphMobile.png")}
                  alt="imgDesktop"
                />
              </Col>
