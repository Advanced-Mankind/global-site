...
const Step1 = ({ title, p1, subtitle, p2 }) => {
    return (
        <>
            <Container className='step1Desktop'>
                <Row>
                    <Col className='imgStyle'>
                        <img src={require('../../../static/01Desktop.png')} alt='imgDesktop' />
                    </Col>
                    <Col>
                        <div>
            ...
            <Container className='step1Tablet'>
                <Row>
                    <Col className='imgStyle' md='3'>
                        <img src={require('../../../static/01MobileTablet.png')} alt='imgTablet' />
                    </Col>
                    <Col md='9'>
            ...
            <Container className='step1Mobile'>
                <Row>
                    <Col className='imgStyleMobile' sm='12' style={{ position: 'relative' }} >
                        <img src={require('../../../static/01MobileTablet.png')} alt='imgMobile' />
                    </Col>
